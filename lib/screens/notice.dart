...
class Notice extends StatefulWidget {
  ...
  Notice(String titulo, String mensaje, String autor, String fecha, bool admin, List<String> usuariosNotificados){
    this.titulo = titulo;
  ...
  State<StatefulWidget> createState() {
    if(admin){
      return NoticeStateAdmin(titulo,mensaje,autor,fecha,usuariosNotificados);
    }
